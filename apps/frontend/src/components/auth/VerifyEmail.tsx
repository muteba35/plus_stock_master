...
function VerifyEmailContent() {
  ...
  return (
    <div className="w-full max-w-[460px] bg-white rounded-[2.5rem] shadow-[0_32px_64px_-12px_rgba(15,23,42,0.1)] border border-slate-100 p-8 lg:p-14 relative">
      <header className="text-center">
        ...
        {/* FIX : Le message de feedback est sorti de la condition pour fonctionner PARTOUT */}
        {message.text && (
          <motion.p 
...
// 2. Export principal enveloppé dans un Suspense exigé par Next.js
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6 pt-32 selection:bg-indigo-100 font-sans relative overflow-hidden">
        ...
        {/* Le Suspense intercepte le hook useSearchParams pendant le build statique */}
        <Suspense fallback={
          <div className="w-full max-w-[460px] bg-white rounded-[2.5rem] p-8 lg:p-14 flex items-center justify-center">
