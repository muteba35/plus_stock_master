...
export default function MouvementsStockPage() {
  return (
    <div className="space-y-6 bg-[#f9fafd] p-6 rounded-3xl min-h-screen text-slate-800">
      <div>
        <h1 className="text-xl font-bold text-slate-900">Mouvements Stock</h1>
        <p className="text-xs text-slate-400 font-medium">Entrees, sorties et ajustements de stock.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-10 text-center">
        ...
        <p className="text-sm font-bold text-slate-900">Interface mouvements en preparation</p>
      </div>
    </div>
  );
}
