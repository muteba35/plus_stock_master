              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[1040px] text-left text-xs">
                  ...
                  <tbody className="divide-y divide-slate-100">
                    ...
                    {paginatedSales.length === 0 && <tr><td colSpan={11} className="px-5 py-12 text-center text-slate-400">Aucune vente trouvee.</td></tr>}
                  </tbody>
                </table>
              </div>
