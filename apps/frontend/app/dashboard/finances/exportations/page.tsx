...
export default function FinanceExportsPage() {
  ...
  return <FinanceShell>
    <CashHeader title={du("mb34b69d341ea")} subtitle={du("m2cc02c5994ab")} />
    <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <ExportCard title={du("md5f65d478abb")} text="Export detaille avec resume, ventes, paiements, caissiers et retours." href="/dashboard/caisse/rapports" />
      <ExportCard title={du("m9cb3bcee7ddc")} text="Export financier consolide depuis le sous-menu Rapports d'activite." href="/dashboard/finances/rapports" />
    </section>
  </FinanceShell>;
}
