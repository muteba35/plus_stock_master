...
const boutiqueSchema = new mongoose.Schema(
...

  {
    ...
    appearance: {
      ...
      secondaryColor: { type: String, match: /^#[0-9A-Fa-f]{6}$/, default: "#0F172A" },
      accentColor: { type: String, match: /^#[0-9A-Fa-f]{6}$/, default: "#10B981" },
      logo: { type: String, default: "", maxlength: 900000 },
    },
